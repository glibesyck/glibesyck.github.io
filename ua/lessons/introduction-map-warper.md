...
{% include figure.html filename="figure1.jpg" alt="A historical map warped into an irregular quadrilateral shape, and overlaid onto a larger-scale contemporary map" caption="Зображення 1: A map too warped to be used effectively." %}
